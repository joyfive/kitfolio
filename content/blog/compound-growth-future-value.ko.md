...
직접 숫자를 넣어보고 싶다면 [복리 성장 계산기](/cagr-calculator?mode=compound-growth)로 미래값을, [CAGR 계산기](/cagr-calculator)로 과거 연평균 성장률을 확인해 보세요. 단일 기간의 변화율은 [성장률 계산기](/growth-rate-calculator)로 빠르게 구할 수 있습니다.
